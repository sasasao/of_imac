...
Particles::Particles(string filePath_meme, string filePath_first){
    ...
    centerPos = ofVec3f(ofRandom(ofGetWidth()/2-1000, ofGetWidth()/2+1000), ofRandom(ofGetHeight()/2 -600, ofGetHeight()/2 +600), 500);
...
void Particles::resetOffWalls(){
    float meshSize = 0;
    float minx = ofGetWidth()/2  -1000;
    float miny = ofGetHeight()/2 -600;
    float minz = -1000;
    float maxx = ofGetWidth()/2  +1000;
    float maxy = ofGetHeight()/2 +600;
    float maxz = -600;

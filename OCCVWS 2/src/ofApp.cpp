...
void ofApp::draw(){
    ...
    color_sle = ofMap(morph_sle, min_value_sle, max_value_sle, 0, 255);
    float color_sle1 = ofMap(morph_sle1, min_value_sle1, max_value_sle1, 0, 255);
    ...
    ofSetColor(color_sle, 200, 200, 50);
    ofBeginShape();
    ...
    ofSetColor(230, 128, color_sle1, 50);
    ofBeginShape();
